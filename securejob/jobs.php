    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Please complete your profile to bid for this job.</p>
        </div>
                    ...
                    <div class="tab_container">
                    	<div id="tab1" class="tab_content">
                    		...
                    		<div class="stj_sort">
                    			...
                    			<div class="srch_dv">
                    				<input type="text" name="srh_newjobs" id="srh_newjobs" class="txt_srch"  value="<?php echo $search_val;?>" placeholder="Search" />
