   ...
   while($rows=mysql_fetch_array($featurejob))
   {
		...
		$data.='<li>
					...
					<div class="stj_jl_img">
						<a class="a_pyb" href="place-bid.php?job_id='.$rows["job_id"].'"><img src="'.$img.'" alt=""/></a>
					</div>
					...
					<div class="stj_jl_rgt">
						...
						<a class="a_pyb" href="place-bid.php?job_id='.$rows["job_id"].'">Place your bid</a>
