...
$sql=mysql_query("select tbluser.user_id,tbluser.email,tbluser.firstname,tbluser.lastname,tbluser.address_1,tbluser.address_2,tbluser.address_3,tbluser.city_id,tbluser.state_id,tbluser.profile_image from tbluser ".$join_category." LEFT JOIN hire_candidates ON tbluser.user_id=hire_candidates.requested_user_id  where tbluser.status=1 ".$catjoin."  ".$user_cond." and tbluser.customer_type=2 ".$searchtxt." and hire_candidates.request_user_id=".$_SESSION['user_id']." ".$orderby." LIMIT $start,$pagelimit");
