...
function load_more(page,cat,sort,radius){
	...
	if(search!='' && search!=undefined)
	{
      ...
      $.ajax(
            {
                url: 'get_completeduser_jobs?page='+page+'&category='+cat+'&sort='+sort+searchval+'&radiuscat='+radius,
                type: "get",
                datatype: "html",
                beforeSend: function()
                {
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 stj_jb">
				<div class="stj_jb_inr">
					...
					<ul class="tabs">
                      <li class="my_cmpltd"><a href="#tab1">My Completed Jobs</a></li>
                    ...
                    <div class="tab_container">
                    	<div id="tab1" class="tab_content">
                    		...
                    		<div class="stj_ad_srch" style="display:none">
