...
if(isset($_SESSION['user_id']) && $_SESSION['user_id']!='')
{
	...
	$verified_user=$rows['verified_user'];	
			...
			<div class="bp_dv">
				...
				<div class="ip_profile">
					...
					<div class="bp_dv_lftdtl">
					    ...
					    <div class="ip_avail">
							<h3>Availability <a href="javascript:void(0);" id="">(Change Availability)</a></h3>
							<!--<div id="avail_select">
								<?php 
							...
							<div class="bank_dtl prsnl_dtl" style="border-bottom:none;">
								...
								<ul>
									...
									<li>
										<br/>
										<div class="srch_prf">
											<input type="text" id="_test" class="txt_search" placeholder="Search Location" />
											<input type="button" class="btn_search" id="new_srch" value="Go" />
										</div>
									</li>
									<li>
										<div id="map"></div>
				      ...
				      <div class="messages">
					   ...
					   <div class="comn-list">
						   <div class="list-row">
							...
							?>
							 <div class="list-row">
						         <div class="box-color">
									<div class="title"><span><a href="notification.php">ALL NOTIFICATIONS</a></span></div>
					   ...
					   <div class="clear"></div>
						 ...
						 <div class="comn-list profile-row">
						 	...
						 	?>
						     <div class="list-row">
							     <!-- <div class="title"><span>ALL NOTIFICATIONS sdddd</span></div>
								  <div class="numbar"><?php echo $obj->countNotifications($_SESSION['user_id']); ?></div> -->
							 </div>
							 <div class="list-row">
				     ...
				     <div class="col-md-4 col-sm-6 dasbrod-row">
				         <div class="border-box">
						       <div class="availablity">
							        <div class="dasbrod-title">
						                 <h2><i class="fas fa-calendar-alt"></i> AVAILABILITY & CALENDER</h2>
					                 </div>
									  <div class="comn-list">
									        <div class="list-row">
											    <div class="box-color">
												    <div class="title"><span><a href="javascript:void(0);" id="edit_availability">CHANGE AVAILABILITY</a></span></div>
												</div>
											 	<div class="calender">
								    			 	<a id="calendar_btn" data-toggle="modal" data-target="#mycalander" class="a_as" data-view="1" href="#"><img src="images/calender.png" style="width:22px;height: 22px;"></a>
								 				</div>
												 <div id="avail_select">
								<?php 
								$availSql = mysql_query("SELECT * FROM tbluser_availability WHERE user_id=".$_SESSION['user_id']." ORDER BY day_id ASC");
								...
								<p id="availability">
									<?php while($availRow = mysql_fetch_assoc($availSql)){ ?>
									<?php echo "<span class='availability_set' style='clear:both;'>" ?>
									<?php echo ucfirst($availRow['from_day']); ?> <?php echo $availRow['from_time']; ?> - <?php echo $availRow['to_time']; ?>
									<?php echo "</span>" ?>
									<?php } ?>
								</p>
							...
							<div class="container"> 
									<div class="modal fade" id="mycalander" role="dialog">
								    <div class="modal-dialog">
								      ...
								      <div class="modal-content">
								        ...
								        <div class="modal-footer">
								          <button type="submit" class="btn btn-default" id="close_modal_cal" data-dismiss="modal">Close</button>
								        </div>
								      </div>
                                     ...
                                     <div class="comn-list">
									      <div class="list-row">
										      <!-- <div class="title"><span>MYJOBS AWAITING REVIEW</span></div> -->
											   <!-- <div class="numbar"><?php echo $reviewsRow; ?></div> -->
										  </div>
										   <div class="list-row">
											 <div class="box-color">
											 ...
											 <div class="box-color">
												...
												<div class="title"><span>MY REVIEWS</span></div>
												<div class="numbar" style="color:#ffffff"><?php echo $rating_row_count; ?></div>
											</div>
											</div>
											 <div class="list-row">
											 	<div class="box-color">
													<div class="title"><span>MY RATINGS</span></div>
													<div class="numbar" style="color:#ffffff"><?php echo $overallRating."%"; ?></div>
												</div>
											</div>
										<div class="list-row">
...
$course = mysql_query("SELECT tblcoursemaster.course_title as title,tblcoursemaster.start_date as start,tblcoursemaster.end_date as end_date,tbl_course_payment.course_id as url FROM tblcoursemaster
LEFT JOIN tbl_course_payment ON tblcoursemaster.course_id=tbl_course_payment.course_id
WHERE  tblcoursemaster.status=1 AND tblcoursemaster.start_date >='".date("Y-m-d h:i:s")."'AND tbl_course_payment.txnid != '' AND tbl_course_payment.user_id=".$_SESSION['user_id']."");

$siteUrl = SITE_URL.'newcourse_details.php?course_id=';
while($featurecourseArray = mysql_fetch_assoc($course)){
	$featurecourseArray['title'] = 'Course Booked';
	$featurecourseArray['url'] = $siteUrl.$featurecourseArray['url'];
	$featurecourseArray['start'] = $featurecourseArray['start'];
	$featurecourseArray['end'] = $featurecourseArray['end_date'];
	$json[] = $featurecourseArray;
}
...
while($featurejobArray = mysql_fetch_assoc($featurejob)){
	$featurejobArray['title'] = 'Job Booked';
...
$(document).ready(function() {
	$("#calendar_btn").click(function(){
		...
		if(dataView == 1){
			//$("#availability").hide();
			$('#mycalander').modal('show');
			$(".modal-body > #calendar").css("display","block");
			$("#calendar_btn").attr("data-view","2").val(2);
			$("#calendar_btn").html("<img src='images/calender.png' style='width:22px;height: 22px;'>");
...
<script>
	...
	$("#close_modal_cal").on("click",function(){
		$('#mycalander').modal('hide');
		$("#availability").show();
		$("#calendar_btn").attr("data-view","1").val(2);
		$("#calendar_btn").html("<img src='images/calender.png' style='width:22px;height: 22px;'>");
	});
