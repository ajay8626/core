...
// Get data from db for modification 
	...
	$sql1 = "select location_id from tbllocation where locationname = '$name'"; 
	//echo $sql1;
	//exit;
	$result1 = $db->Query($sql1);
    $location_id=0;
    list($location_id)= mysql_fetch_row($result1);
    $db->Free($result1);
    ...
    <!-- Content Header (Page header) -->
		<section class="content-header">
		  ...
		  <ol class="breadcrumb">
			...
			<li><a href="<?php echo ADMIN_URL; ?>main.php?pg=viewstate"><i class="fa fa-location-arrow"></i>County</a></li>
					...
					<div class="col-md-6">
					  ...
					  <div class="box box-primary">
						<div class="box-header with-border">
						  <h3 class="box-title">Modify County</h3>
						</div>
						<div class="error"></div>
						<!-- /.box-header -->
						<!-- form start -->
