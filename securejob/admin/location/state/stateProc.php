...
if($act == "add"){	
	 ...
	 {			
		...
		$data1 = array('locationname'=>$state,'status'=>1);
		$db->Insert($data1,"tbllocation");
...
{		
	...
	{			
        ...
        $where2 ="location_id ={$location_id}";
        $data2 = array('locationname'=>$state,'status'=>1);
		$db->Update($data2,"tbllocation",$where2);
