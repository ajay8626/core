	...
	<section class="content">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="error"></div>
				<div class="box-body">
				<form class="validateForm" name="frmadminadded" id="category_form" method="post" action="" enctype="multipart/form-data">
			<?php 
			if ($id!=0) {
			...
			<div class="form-group">
				...
				<textarea class="form-control" style='min-height:300px;' name="description" data-errormessage-value-missing="Please add some description." data-validation-engine="validate[required]" ><?php echo $description; ?></textarea>			
			...
			<div class="checkbox">
				...
				<div class="box-footer">
					<button type="submit" id="submit_category"  name="submit_me"  class="btn btn-primary">Submit</button>
				</div>
			</form>
				</div>
				</div>
