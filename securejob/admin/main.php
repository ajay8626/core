<?php
	...
	if(isset($_REQUEST['pg']) && $_REQUEST['pg']!=""){
		...
		elseif($pg == 'viewusercourse'){
			$mfile = "course/viewlist.php";
			$title = TITLE."&nbsp;-&nbsp;Course Management";
		}
		elseif($pg == 'viewcoursedetail'){
			$mfile = "course/coursedetail.php";
			$title = TITLE."&nbsp;-&nbsp;Course Management";
		}
		elseif($pg == 'addcourse'){
		...
		elseif($pg == 'viewwords'){
			$mfile = "words/view_words.php";
			$title = TITLE."&nbsp;-&nbsp; Words";
		}

		elseif($pg == 'addbuild'){
			$mfile = "build/process_build.php";
			$title = TITLE."&nbsp;-&nbsp; Build";
		}elseif($pg == 'modtag'){
			$mfile = "build/process_build.php";
			$title = TITLE."&nbsp;-&nbsp; Build";
		...
		elseif($pg == 'viewbuild'){
			$mfile = "build/view_build.php";
			$title = TITLE."&nbsp;-&nbsp; Build";
		}
		
		elseif($pg == 'addlanguage'){
			$mfile = "language/process_language.php";
			$title = TITLE."&nbsp;-&nbsp; Language";
		}elseif($pg == 'modlanguage'){
			$mfile = "language/process_language.php";
			$title = TITLE."&nbsp;-&nbsp; Language";
		}
		elseif($pg == 'viewlanguage'){
			$mfile = "language/view_language.php";
			$title = TITLE."&nbsp;-&nbsp; Language";
		}
		
		elseif($pg == 'addnationality'){
			$mfile = "nationality/process_nationality.php";
			$title = TITLE."&nbsp;-&nbsp; Nationality";
		}elseif($pg == 'modnationality'){
			$mfile = "nationality/process_nationality.php";
			$title = TITLE."&nbsp;-&nbsp; Nationality";
		}
		elseif($pg == 'viewnationality'){
			$mfile = "nationality/view_nationality.php";
			$title = TITLE."&nbsp;-&nbsp; Nationality";
		}
		
		// job status
		
		elseif($pg == 'viewjobstatus'){
			$mfile = "jobstatus/viewjobstatus.php";
			$title = TITLE."&nbsp;-&nbsp;Job Status Management";
		}
		elseif($pg == 'addjobstatus'){
			$mfile = "jobstatus/addjobstatus.php";
			$title = TITLE."&nbsp;-&nbsp;Add Job Status";
		}
		elseif($pg == 'jobstatusproc'){
			$mfile = "jobstatus/jobstatusProc.php";
		}
		elseif($pg == 'modjobstatus'){
			$title = TITLE."&nbsp;-&nbsp;Modify Job Status";
			$mfile = "jobstatus/modjobstatus.php";
		}
		...
		elseif($pg == 'addcoupon'){
			$mfile = "coupon/process_coupon.php";
			$title = TITLE."&nbsp;-&nbsp; Coupons";
		}
		elseif($pg == 'viewcoupon'){
			$mfile = "coupon/view_coupon.php";
			$title = TITLE."&nbsp;-&nbsp; Coupons";
		}
		// faq
		elseif($pg == 'addfaq'){
			$mfile = "faq/process_faq.php";
			$title = TITLE."&nbsp;-&nbsp; Faq's";
		}
		elseif($pg == 'viewfaq'){
			$mfile = "faq/view_faq.php";
			$title = TITLE."&nbsp;-&nbsp; Faq's";
		}
