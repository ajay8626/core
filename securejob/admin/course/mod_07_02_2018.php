...
// Get data from db for modification 
	...
	$result = $db->Query($sql);
	$a_name = "";
	list($course_id,$name,$description,$price,$image,$course_days,$course_hours,$course_time,$start_date,$latitude,$longitude,$address1,$address2,$postalcode,$country_id,$state_id,$city_id,$created_date,$isfeatured,$status) = mysql_fetch_row($result);		
	/* echo "<pre>";
						...
						<input type="hidden" value="<?php echo $a_id;?>" name="id">
						  <div class="box-body">
							...
							<div class="form-group">
								...
								<input type="number" maxlength='4' name="course_days" id="days"   data-errormessage-value-missing="Please enter valid data." data-validation-engine="validate[required,custom[number]]" class="form-control" value="<?php echo $course_days; ?>"  min="1" max="31" />
							</div>
							<?php
							$date = '';
							if($start_date != '')
							...
							<div class="checkbox">
								<label><input type="checkbox" value="1" name="status" <?php echo $isActiveChecked; ?>  > NOTE:- Please tick this checkbox if you want to active course account </label>
