						...
						<input type="hidden" value="add" name="act">
						  <div class="box-body">
							...
							<div class="form-group">
								...
								<input type="text" name="link" id="link" class="form-control input3 mini" placeholder="Enter Advert Link" data-validation-engine="validate[required]" data-errormessage-value-missing="Please enter advert link" maxlength="50"  >
							</div>
							<div class="form-group">
