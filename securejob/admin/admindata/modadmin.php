					...
					<div class="form-group">
						<label>Select User Rights </label><span style="color:#FF0000;">*</span>
							...
							<select class="form-control" name="c_chk[]" class="mini" size="6" multiple data-validation-engine="validate[required]" data-errormessage-value-missing="Please select at least one right." style="width: 320px;" >
								...
								<option <?php if(in_array('2',$rst_val)){ echo 'selected';} ?> value="2">Location</option>
								...
								<option value="11" <?php if(in_array('11',$rst_val)){ echo 'selected';} ?>>Course Manager</option>
								<option value="12" <?php if(in_array('12',$rst_val)){ echo 'selected';} ?>>Advert Manager</option>
								<option value="13" <?php if(in_array('13',$rst_val)){ echo 'selected';} ?>>Rating Manager</option>
							</select>
