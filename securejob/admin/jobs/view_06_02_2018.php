					  ...
					  <input type="hidden" name="delId" id = "delId" value="" />	
						...
						if(mysql_num_rows($select_query)){
							...
							echo "<tr>
										...
										<td>".$row["price"]."</td>";?>
										<td><?php echo "<a href='main.php?pg=viewjobbids&id=".$row["job_id"]."' target='_blank'>".bidsCount($row["job_id"])."</a>"; ?></td>
										<td>
										...
										<a class='btn btn-warning' onclick="return confirm('Are you sure want to delete this job?')" href='main.php?pg=viewjobs&id=<?=$row["user_id"]?>' title="are you sure want to delete this job?">Delete</a></td>
									 </tr>
						<?php			 
