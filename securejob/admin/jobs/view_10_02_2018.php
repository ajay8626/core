					 ...
					 <form method="post" name="form">	
					  ...
					  <input type="hidden" name="delId" id = "delId" value="" />	
						...
						<tr>
						  ...
						  <th style="text-align:right;">No. of Bids</th>
						  <th>Status</th>
						  <th>Action</th>
						</tr>
						</thead>
						...
						if(mysql_num_rows($select_query)){
							...
							echo "<tr>
										...
										<a class='btn btn-warning' onclick="return confirm('Are you sure want to delete this job?')" href='main.php?pg=viewjobs&id=<?=$row["job_id"]?>' title="are you sure want to delete this job?">Delete</a></td>
									 </tr>
						<?php			 
