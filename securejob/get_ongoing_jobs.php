...
//echo "<pre>";print_r("select tbljobs.*,tbljobstatus.status as jobstatus,tbljobsapplied.bidprice as finalprice from tbljobs  LEFT JOIN tbljobcategories ON tbljobs.job_id=tbljobcategories.job_id LEFT JOIN tbljobstatus ON tbljobs.job_id=tbljobstatus.job_id LEFT JOIN  tbljobsapplied ON tbljobs.job_id=tbljobsapplied.job_id where  tbljobs.status=1 and tbljobs.job_status=3  ".$catjoin." ".$user_cond." and tbljobs.payment_status=1 ".$searchtxt." and tbljobsapplied.user_id=".$_SESSION['user_id']." ".$orderby." LIMIT $start,$pagelimit");exit;


$featurejob=mysql_query("select tbljobs.*,tbljobstatus.status as jobstatus,tbljobsapplied.bidprice as finalprice from tbljobs  LEFT JOIN tbljobcategories ON tbljobs.job_id=tbljobcategories.job_id LEFT JOIN tbljobstatus ON tbljobs.job_id=tbljobstatus.job_id LEFT JOIN  tbljobsapplied ON tbljobs.job_id=tbljobsapplied.job_id where  tbljobs.status=1 and tbljobs.job_status=3  ".$catjoin." ".$user_cond." and tbljobs.payment_status=1 ".$searchtxt." and tbljobsapplied.user_id=".$_SESSION['user_id']." ".$orderby." LIMIT $start,$pagelimit");
