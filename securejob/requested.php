...
<title>Search Candidate - Requested - SECURE THAT JOB</title>
...
function load_more(page,cat,sort){
	...
	if(search!='' && search!=undefined)
	{
      ...
      $.ajax(
            {
                url: 'get_requested.php?page='+page+'&category='+cat+'&sort='+sort+searchval,
                type: "get",
                datatype: "html",
                beforeSend: function()
                {
			...
			<div class="col-xs-12 col-md-8 stj_jb">
				...
				<?php echo getMsg(); ?>
					<ul class="tabs">
                      ...
                      <li class="active"><a href="requested.php">Requested</a></li>
