...
if($courseDuration!='')
{
	$courseDurationJoin=" and tblcourse.course_days like '%".$courseDuration."%'";	
}
...
if($courseLocation!='')
{
	$courseLocationJoin=" and tblcourse.course_location like '%".$courseLocation."%'";	
}
...
{
	$radiusjoin = ' and (';
	$radiusjoin .=" getDistancemiles(tblcourse.latitude, tblcourse.longitude, ".$lat.", ".$long.") <= ".$zipMiles." )";
} 

//Text Search
if($courseTitle!='')
{
	$titleJoin=" and (tblcourse.name like '%".$courseTitle."%')";
}

//Job Price
if($coursePrice!='')
{
	$coursePriceJoin=" and (tblcourse.price <= ".$coursePrice.")";
}
...
$sql=mysql_query("select * from tblcourse where tblcourse.status=1 ".$titleJoin." ".$courseLocationJoin." ".$courseDurationJoin." ".$coursePriceJoin." ".$dateBetween." ".$radiusjoin." ");


$s = "select * from tblcourse where tblcourse.status=1 ".$titleJoin." ".$courseLocationJoin." ".$courseDurationJoin." ".$coursePriceJoin." ".$dateBetween." ".$radiusjoin." LIMIT $start, $pagelimit";
//echo $s; exit;
//echo $sql;
