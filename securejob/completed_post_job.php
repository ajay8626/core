...
<title>Completed Post Jobs - SECURE THAT JOB</title>
...
jQuery(document).ready(function($) {
	...
	$(".tab_content").hide(); 
	$("ul.tabs li:nth-child(5n)").addClass("active").show();
...
function load_more(page,cat,sort){
	...
	if(search!='' && search!=undefined)
	{
      ...
      $.ajax(
            {
                url: 'get_completed_post_job.php?page='+page+'&category='+cat+'&sort='+sort+searchval,
                type: "get",
                datatype: "html",
                beforeSend: function()
                {
