...
if ($client->getAccessToken()) {
  ...
  if($noofrows > 0)
	...
	else
	{
		...
		firstname='".$user['given_name']."',lastname='".$user['family_name']."',created_date='".date('Y-m-d h:i:s')."',customer_type=2,gender=".$gender.",password='',phone='',address_1='',address_2='',profile_image='',status=1,googleID='".$user['id']."',isSocial=2,last_login='".date("Y-m-d h:i:s")."',referralCode='".$referralCodeValue."'");
