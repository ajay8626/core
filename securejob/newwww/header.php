      ...
      <div class="navigation"> <a href="#" class="lines-button x2"><span class="lines"></span></a>
        <div class="main_menu">
          	<ul class="firstul">
				...
				<?php } ?>
				<li <?php if(basename($_SERVER['PHP_SELF'])=='course.php'){ ?> class="current_page_item" <?php } ?>><a href="course.php">courses</a></li>
          	</ul>
        </div>
		<?php if(isset($_SESSION['user_id'])){ 
		      $link='login.php';
		...
		$nameSql = "SELECT firstname FROM tbluser WHERE user_id=".$_SESSION['user_id']."";
