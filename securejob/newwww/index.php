...
<ul class="joinlist">
	...
	<li>
		<div class="j_icon"><img src="images/AT THE RIGHT TIME.svg" width="35" height="48" alt=""/></div>
		<h4>AT THE RIGHT TIME</h4>
	</li>
	<li>
		<div class="j_icon"><img src="images/FIND THE RIGHT PRICE.svg" width="35" height="48" alt=""/></div>
		<h4>FIND THE RIGHT PRICE</h4>
	</li>
	<li>
		<div class="j_icon"><img src="images/RATING SYSTEM.svg" width="35" height="48" alt=""/></div>
		<h4>RATING SYSTEM</h4>
	</li>
	<li>
		<div class="j_icon"><img src="images/GET PAID FAST.svg" width="35" height="48" alt=""/></div>
		<h4>GET PAID FAST</h4>
	</li>
</ul>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 subtxt">
				<h4>Insurance</h4>
				<?php 
			$inssql='select title,content,page_id from tblcmspages where page_id=11';
			...
			<div class="col-sm-6 subtxt">
				<h4>Disputes</h4>
				<?php 
			$dissql='select title,content,page_id from tblcmspages where page_id=12';
