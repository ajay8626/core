			...
			<div class="login_dv">
				...
				<?php echo getMsg(); ?>
					...
					<ul>
					   <form method="post" name="login_form" action="check_login.php">
							...
							<li class="keep-me-logged">
								<div class="tk">
									<label for="terms-personal"><input type="checkbox" name="terms-personal" id="terms-personal" value="1" data-toggle="modal" data-target="#postingFees">Keep me logged in </label>
								</div>
							</li>
							<li>
					...
					<div class="lg_social">
						...
						<a class="lg_g" href="#"><img src="images/g.png" alt=""/>Sign in with Google</a>
					</div>
				</div>
				...
				<div class="lg_dv_rgt">
					...
					<ul>
						...
						<li>
							<label>Email Address <em>*</em></label>
							<!-- <input type="text" required name="customer_email" id="customer_email" maxlength="100" class="txt_lg" onblur="return get_check(this.value)" value="<?php /* echo $home_email; */ ?>" /> -->
						...
						<li>
							<input type="hidden" name="checkUser" value="" id="check_regis"/>
