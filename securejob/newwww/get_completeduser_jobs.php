   ...
   while($rows=mysql_fetch_array($featurejob))
   {
		...
		$data.='<li>
                    					...
                    					<div class="stj_jl_img">
											<a class="a_pyb" href="biddetails.php?job_id='.$rows["job_id"].'&flag=complete"><div class="gnrt_img" style="background-image: url('.$img.');"></div></a>
                    					</div>
                    					<div class="stj_jl_dtl">
											<a class="a_pyb" href="biddetails.php?job_id='.$rows["job_id"].'&flag=complete"><h2>'.$rows['job_name'].'</h2></a>
                    						<h5>('.$jobcategory.')</h5>
                    						<div class="stj_jd_cn">
                    					...
                    					<div class="stj_jl_rgt">
                    						...
                    						<div class="stj_jd_cn">
                    							...
                    							<p>Finalised Price: <span>£'.round(maxbidprice($rows["job_id"])).'</span></p>
                    						</div>
                    						<a class="a_pyb" href="biddetails.php?job_id='.$rows["job_id"].'&flag=complete">Give Feedback</a>
