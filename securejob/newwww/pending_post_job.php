...
<title>Pending Payments Jobs - SECURE THAT JOB</title>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: '<?php echo LanguageList; ?>', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
}
</script>
<script>
...
function load_more(page,cat,sort){
	...
	if(search!='' && search!=undefined)
	{
      ...
      $.ajax(
            {
                url: 'get_pending_post_job.php?page='+page+'&category='+cat+'&sort='+sort+searchval,
                type: "get",
                datatype: "html",
                beforeSend: function()
                {
			...
			<div class="col-xs-12 col-md-8 stj_jb">
				<div class="stj_jb_inr">
					...
					<ul class="tabs tabs_anj">
                      ...
                      <li class="active"><a href="#tab2">Pending Payments</a></li>
