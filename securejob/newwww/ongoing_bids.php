...
<title>Ongoing Bids - SECURE THAT JOB</title>
...
function load_more(page,cat,sort){
	...
	//alert(page);
      $.ajax(
            {
                url: 'get_jobs_ongoing_bids.php?page='+page+'&category='+cat+'&sort='+sort+searchval,
                type: "get",
                datatype: "html",
                beforeSend: function()
                {
			...
			<div class="col-xs-12 col-md-8 stj_jb">
				<div class="stj_jb_inr">
					...
					<ul class="tabs">
                      ...
                      <li class="active"><a href="#tab2">Ongoing Bids</a></li>
