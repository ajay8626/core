...
var $_width;
var $_height;
var $_imageTypes = array("1"=>"pdf", "2"=>"doc", "3"=>"docx"); //, 4 = SWF, 5 = PSD, 6 = BMP, 7 = TIFF(intel byte order), 8 = TIFF(motorola byte order), 9 = JPC, 10 = JP2, 11 = JPX, 12 = JB2, 13 = SWC, 14 = IFF, 15 = WBMP, 16 = XBM);
var $_error = FALSE;
var $_errMsg = array();

	// set original file parameters
	function file_upload($path,$filename) {
		$this->_path=$path;
