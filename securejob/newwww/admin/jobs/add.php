					  ...
					  <div class="box box-primary">
						...
						<input type="hidden" value="add" name="act">
						  <div class="box-body">
							...
							<div class="form-group">
								<label>Opening Position</label><span style="color:#FF0000;">*</span>
								<input type="text" name="opening_position" id="opening_position" class="form-control" placeholder="Enter Opening Position" data-validation-engine="validate[required]" data-errormessage-value-missing="Please enter opening position"  maxlength="10" >
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Category</label><span style="color:#FF0000;">*</span>
								<?php 
								
								$selectCategories = mysql_query("SELECT category.category_id, category.category_name FROM tblcategory as category WHERE category.isactive=1 order by category.category_name");
								?>				
							...
							<div class="form-group">
								...
								<input type="number" maxlength='4' name="hours" id="hours" value=""  data-errormessage-value-missing="Please enter valid data." data-validation-engine="validate[required,custom[number]]" class="form-control"  />
							</div>
							<div class="form-group">
								<label>Days</label><span style="color:#FF0000;">*</span>
								<input type="number" maxlength='4' name="days" id="days" value=""  data-errormessage-value-missing="Please enter valid data." data-validation-engine="validate[required,custom[number]]" class="form-control"  />
							</div>
						...
						<!-- /.input group -->
							...
							<div class="form-group">
							  ...
							  <input type="text" name="latitude"  id="latitude" class="form-control" placeholder="Enter Latitude" maxlength="20">
							</div>
							<div class="form-group">
							  <label>Longitude</label><span style="color:#FF0000;">*</span>
							  <input type="text" name="longitude"  id="longitude" class="form-control" placeholder="Enter Longitude" maxlength="20">
							</div>
