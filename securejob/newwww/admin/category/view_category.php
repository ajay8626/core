...
$Query= "SELECT * from tblcategory order by category_name asc";
...
<div class="content-wrapper">
	...
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
		...
		<li><a href="#"><i class="fa fa-tree"></i>Categories</a></li>
				 ...
				 <form method="post" name="form">	
				  ...
				  <input type="hidden" name="delId" id = "delId" value="" />	
					...
					if(mysql_num_rows($result)){
						...
						if($row['image']!='')
						{
							$image='<img src='.CATEGORY_IMG_URL.$row['image'].' width="75px">';
						}
						...
						echo "<tr>
									...
									<td>
										<a class='btn btn-primary' href='main.php?pg=addcategory&id=<?=$row["category_id"]?>'>Modify</a>
										<a class='btn btn-warning' onclick="return confirm('Are you sure want to delete this category?')" href='main.php?pg=viewcategories&delId=<?=$row["category_id"]?>' title="are you sure want to delete this category?">Delete</a>
									</td>
							 </tr>
					<?php			 
					...
					<div >
						...
						<button type="button" onclick="location.href='main.php?pg=addcategory'"  name="submit_me"  class="btn btn-primary">Add</button>
					</div>
				  </form>
				</div>
				<!-- /.box-body -->
...
function changeContent(id,val){
	...
	$.ajax({
		type: "POST",
		dataType: "json",
		url: "phpajax/CategoryActiveInactive.php", 
		data: data,
		beforeSend: function() {
