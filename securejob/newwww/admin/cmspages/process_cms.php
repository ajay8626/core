		...
		<div class="row">
			...
			?>
				...
				<div class="form-group">
					...
					<input name="page_title" type="text" value="<?php echo $page_title; ?>"  data-errormessage-value-missing="Please enter title" data-validation-engine="validate[required]" maxlength="50" class="form-control" />
				</div>
				<?php /* ?>	
				<div class="form-group">
				...
				<div class="form-group">
					...
					<select style="width: 320px;" class="form-control" name="is_active">
						<option value="active" <?php if($is_active=="active") { echo "selected";} ?>>Active</option>
