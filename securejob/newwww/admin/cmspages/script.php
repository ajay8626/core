...
require_once("../../config.php");
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		$status=$aRow['is_active'];
			...
			$row[] = '<a href='.ADMIN_URL.'main.php?pg=addcms&id='.$id.' class="btn btn-primary">Modify</a>&nbsp;<a href='.ADMIN_URL.'main.php?pg=viewcms&delId='.$id.' onclick="'.$confirm.'" class="btn btn-warning hidden" title="Are you want to delete this page?"> Delete </a>';
