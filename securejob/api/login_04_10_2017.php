...
if(isset($rqst_data->function)){
	...
	if($Username != "" && $Password != "" ){
			...
			$sql="select id,email,firstname,lastname,phone,address_1,address_2,address_3,postal_code,leads,customer_type,status from tblcustomers where email ='".$Username."' and password ='".$Password."'";
			$res=$db->Query($sql);
			$rows1=mysql_num_rows($res);
			list($id,$email,$firstname,$lastname,$phone,$address_1,$address_2,$address_3,$postal_code,$leads,$customer_type,$status)=mysql_fetch_row($res);
