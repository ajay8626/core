			...
			<div class="col-xs-12 col-md-10 stj_bid">
				<div class="stj_bid_wrap">
					...
					<div class="stj_bid_btm">
                        ...
                        /*echo "<pre>";print_r("select user.user_id,user.firstname,user.lastname,job.job_name,jobapply.* from tbljobsapplied as jobapply inner join tbljobs as job on jobapply.job_id = job.job_id
                        inner join tbluser as user on user.user_id = jobapply.user_id WHERE jobapply.job_id =".$job_id." and jobapply.user_id!=".$user_id." group by jobapply.id order by jobapply.applied_date desc");exit;*/
