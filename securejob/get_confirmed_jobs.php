...
$featurejob=mysql_query("select tbljobs.* from tbljobs  
	...
	and tbljobs.start_date >='".date("Y-m-d h:i:s")."' ".$catjoin." ".$user_cond." ".$searchtxt." 
	and tbljobsapplied.user_id=".$_SESSION['user_id']." 
	and tbljobsapplied.is_winner = 1 
	group by tbljobs.job_id ".$orderby." LIMIT $start,$pagelimit");
