...
window.setInterval(function(){
     ...
     if(bclass != ''){
     	var individual_profile = bclass.search("individual-profile-class");
	     var business_profile = bclass.search("business-profile-class");

	     if (individual_profile != -1) {
	     	var bclass = $("body").removeClass();
	     	var addClass = 'individual-profile-class'+' '+lang;
	     	$("body").attr('class',addClass);
	     }else{
	     	var bclass = $("body").removeClass();
	     	var addClass = 'business-profile-class'+' '+lang;
	     	$("body").attr('class',addClass);
	     }
     }
});
      ...
      <div class="navigation"> <a href="#" class="lines-button x2"><span class="lines"></span></a>
        ...
        <div class="loginlik <?php echo $profileCLass; ?>"><a href="<?php echo $link; ?>">Hello <?php echo $nameUser; ?></a>
			<ul>
				...
				?>
				<li><a href="notification.php">Notification (<?php echo $obj->countNotifications($_SESSION['user_id']); ?>)</a></li>
